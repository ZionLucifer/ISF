...
class ApprovedFarmerRequests extends StatefulWidget {
  _ApprovedFarmerRequestsState requestsState;
  @override
  _ApprovedFarmerRequestsState createState() {
    requestsState = _ApprovedFarmerRequestsState();
...
class _ApprovedFarmerRequestsState extends State<ApprovedFarmerRequests> {
  SharedPreferences sharedPreferences;
  String userId, mobile;
  List<PendingFarmerModel> _farmerList;
  _getData() async {
  ...
  Future<List<PendingFarmerModel>> _getPendingFarmer() async {
    var response = await http.post(
        ...
        body: {"field_officer_id": userId, "type": "farmer", "status": "0"});
