import 'dart:convert';
import 'package:apps/fieldofficernavigation/pending/detail_pending_fund.dart';
import 'package:apps/model/pending_fund_model.dart';
import 'package:flutter/material.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:http/http.dart' as http;

class PendingFundRequests extends StatefulWidget {
  @override
  _PendingFundRequestsState createState() => _PendingFundRequestsState();
}

class _PendingFundRequestsState extends State<PendingFundRequests> {
  ...
  Future<List<PendingFundModel>> _getPendingFarmer() async {
    var response = await http.post(
        ...
        body: {"field_officer_id": userId, "type": "fund", "status": "1"});
      ...
      child: InkWell(
          onTap: () {
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        DetailPendingFund(farmInfo: farmList)));
          },
          child: ListTile(
            ...
            subtitle: Column(
              ...
              children: [
                ...
                if (farmList?.requestTimestamp?.isNotEmpty ?? false)
                  Text("Req On :${farmList.requestTimestamp}"),
              ],
            ),
            trailing: IconButton(
                icon: Icon(
